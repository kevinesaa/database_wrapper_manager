...
class _IbmDb2OdbcSqlCommand(SqlCommand):
...
class _IbmDb2OdbcTransactionWrapper(TransactionWrapper):
    ...
    def executeQuery(self,queryString:str,params:list[tuple]=None) -> list[dict[str,object]]:
        cursor = self._cursor
        return _IbmDb2OdbcSqlCommand.executeQuery(cursor,queryString,params)
    ...
    def executeBulkStatement(self,queryString:str,params:list[tuple]=None) -> None:
        cursor = self._cursor
        _IbmDb2OdbcSqlCommand.executeBulkStatement(cursor,queryString,params)
...
class IbmDb2OdbcWrapperManager(DatabaseWrapperManager):
    ...
    def executeQuery(self,queryString:str,params:list[tuple]=None) -> list[dict[str,object]]:
        ...
        result = _IbmDb2OdbcSqlCommand.executeQuery(cursor,queryString,params)
        cursor.close()
        return result
    ...
    def executeOneStatement(self,queryString:str,params:tuple=None) -> int:
        ...
        cursor = self.connection.cursor()
        result = _IbmDb2OdbcSqlCommand.executeOneStatement(cursor,queryString,params)
        cursor.close()
        return result
