...
class _SqliteSqlCommand(SqlCommand):
...
class _SqliteTransactionWrapper(TransactionWrapper):
    ...
    def executeQuery(self,queryString:str,params:list[tuple]=None) -> list[dict[str,object]]:
        cursor = self._cursor
        return _SqliteSqlCommand.executeQuery(cursor,queryString,params)
    
    def executeOneStatement(self,queryString:str,params:tuple=None) -> int:
        cursor = self._cursor
        return _SqliteSqlCommand.executeOneStatement(cursor,queryString,params)
    
    def executeBulkStatement(self,queryString:str,params:list[tuple]=None) -> None:
        cursor = self._cursor
        _SqliteSqlCommand.executeBulkStatement(cursor,queryString,params)
...
class SqliteWrapperManager(DatabaseWrapperManager):
    ...
    def executeQuery(self,queryString:str,params:list[tuple]=None) -> list[dict[str,object]]:
        ...
        result = _SqliteSqlCommand.executeQuery(cursor,queryString,params)
        cursor.close()
        del cursor
        return result
    ...
    def executeOneStatement(self,queryString:str,params:tuple=None) -> int:
        ...
        cursor = self.connection.cursor()
        result = _SqliteSqlCommand.executeOneStatement(cursor,queryString,params)
    ...
    def startTransaction(self) -> TransactionWrapper:
        ...
        return _SqliteTransactionWrapper(self,id)        
